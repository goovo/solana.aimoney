  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column type="selection" width="55" />
            ...
            <el-table-column align="left" label="添加时间" prop="createdAt" width="180">
              <template #default="scope">{{ formatDate(scope.row.createdAt) }}</template>
            </el-table-column>
            
            <el-table-column align="left" label="用户UID" prop="userId" width="100" />
            ...
            <el-table-column align="left" label="api Key" prop="key" width="300" />

            <el-table-column align="left" label="api Secret" prop="secret" width="300" />

            <el-table-column align="left" label="api密码(OKx)" prop="passwd" width="120" />
...
const getTableData = async() => {
  const table = await getSysUserApiList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
