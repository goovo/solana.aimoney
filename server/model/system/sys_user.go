...
type SysUser struct {
	...
	InviteCode    string         `json:"inviteCode" gorm:"type:varchar(6);uniqueIndex;comment:推荐码"`                                                       // 推荐码
	ReferrerCode  string         `json:"referrerCode" gorm:"type:varchar(6);index;comment:推荐人推荐码"`                                                       // 推荐人推荐码
}
